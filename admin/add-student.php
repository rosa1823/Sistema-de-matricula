...
?>
<h1 class="text-primary"> Matricula <small class="text-warning"> Nuevo Estudiante</small></h1>
	...
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <input name="pcontact" type="text" class="form-control" id="pcontact" pattern="[0-9]{10}" value="<?= isset($pcontact)? $pcontact: '' ; ?>" placeholder="+9........." required="">
	  	</div>
	  	<div class="form-group">
		    <label for="class">Grado del estudiante</label>
