<?php require_once 'db_con.php'; 
	...
	if (isset($_POST['register'])) {
		...
		$input_error = array();
		if (empty($name)) {
			$input_error['name'] = "Este campo es obligatorio";
		}
		if (empty($email)) {
			$input_error['email'] = "Este campo es obligatorio";
		}
		if (empty($username)) {
			$input_error['username'] = "Este campo es obligatorio";
		}
		if (empty($password)) {
			$input_error['password'] = "Este campo es obligatorio";
		}
		if (empty($photo)) {
			$input_error['photo'] = "Este campo es obligatorio";
		}
...
<html lang="en">
  ...
  <body>
    <div class="container"><br>
          <h1 class="text-center">Registrate</h1><hr><br>
