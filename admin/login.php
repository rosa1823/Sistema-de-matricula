	...
	if (isset($_POST['login'])) {
		...
		if(count($input_arr)==0){
			...
			if (mysqli_num_rows($result)==1) {
				...
				$usernameerr= "EL nombre de usuario no existe";
			}
		}
...
<html lang="en">
  ...
  <body>
    <div class="container"><br>
          <h1 class="text-center">Centro de Administración</h1><hr><br>
            ...
            <div class="col-md-4 offset-md-4">
             	<form method="POST" action="">
				  ...
				  <div class="text-center">
				    ...
				    <p>Si aún no tienes una cuenta de usuario, <a href="register.php">Registrate aqui</a></p>
				  </div>
				</form>
            </div>
          </div>
